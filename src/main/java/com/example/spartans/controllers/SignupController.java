...
public class SignupController {
    ...
    private ResponseEntity<String> signup(@RequestBody SignupRequest signupRequest) {
        ...
        try {
            ...
            // sonar lint: replace to lower case and equals with equals ignore case
            if (!signupRequest.getRole().equalsIgnoreCase("admin") &&
                    !signupRequest.getRole().equalsIgnoreCase("user")) {
                res = ResponseEntity.status(401).body(
            ...
            String hashedPassword = HashPasswordController.generateHashPassword(signupRequest.getPassword());
