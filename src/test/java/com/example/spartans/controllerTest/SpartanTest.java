 ...
 * 
 * Mockito.when(spartanRepository.findById("628caae9342e5fbc7c4bd383")).
 * thenReturn(Optional.of(spartan));
 * Assertions.assertEquals(spartanRepository.findById("628caae9342e5fbc7c4bd383"
 * ), Optional.of(spartan));
 * }
 * 
 * @Test
 ...
 * spartanRepository.save(spartan);
 * Spartan spartanUpdated =
 * spartanRepository.findById("628caae9342e5fbc7c4bd383").get();
 ...
 * boolean result =
 * spartanRepository.findById("628caae9342e5fbc7c4bd383").isEmpty();
